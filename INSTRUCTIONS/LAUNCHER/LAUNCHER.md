...
![Интерфейс режима "Установка программы"](./install_1.png)

2) Вбить необходимые данные для скачивания конфигурации или загрузить её файлом

![Данные для скачивания конфигурации](./install_2.png)

![Загрузка конфигурации](./install_3.png)
...
![Интерфейс режима "Обновление программы"](./update_1.png)

2) Вбить данные для подлкючения по ssh и нажать на большую синюю кнопку
